/**
 * zepto插件：向左滑动删除动效
 * 使用方法：$('.itemWipe').touchWipe({autoRetract: true, item: '.item', itemDelete: '.item-delete'});
 * 参数：itemDelete  删除按钮的选择器
 *       item        条目的选择器
 *       autoRetract 是否自动弹回
 */
;"use strict";
(function ($) {
  $.fn.touchWipe = function (option) {
    ...
    $(this).on('touchstart', function (event) {
      ...
      if(opts.autoRetract == true){
		    $(this).parent().children(opts.item).each(function(index){
		    	if(this  != obj){
