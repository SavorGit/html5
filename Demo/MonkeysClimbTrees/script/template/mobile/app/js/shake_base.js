...
if (!Array.prototype.indexOf) {
    ...
    b.showPage = function(c) {
        var d = b('<div class="frame-dialog" style="background-color:#ffd017"><div class="phbphb" id="phbphb"><img src="'+WEB_URL+'images/phbphb.png" class="phbtop" ><div class="phbk"><div class="phbbiaok"><iframe frameborder="0" style="background-color:#ffd017" src="' + c + '"></iframe></div></div></div><div class="closebutton"></div></div>');
        d.appendTo("body").show().on("click", ".closebutton", 
        function() {
            d.hide(function() {
                d.remove();
                d = null;
				$(".result-layer,.pashuMain").show();
            })
        })
    };
    a.WBActivity = {
    ...
    b(function() {
        ...
        if (game_config.scene_info.need_login == 0) {
            a.WBActivity.hideLoading();
