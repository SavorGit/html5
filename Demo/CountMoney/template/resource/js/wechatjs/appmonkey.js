define('appmonkey',['appsocket','jquery.shake','wechatcore','touch'],function(appsocket,Shake,wechatcore,touch){
	...
	var appmonkey = {
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gamemonkeyrefresh'||data.type=='gameappmonkeyrefresh'){
