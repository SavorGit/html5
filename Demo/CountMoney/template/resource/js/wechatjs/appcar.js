define('appcar',['appsocket','jquery.shake','wechatcore','touch'],function(appsocket,Shake,wechatcore,touch){
	...
	var appcar = {
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gamecarrefresh'||data.type=='gameappcarrefresh'){
