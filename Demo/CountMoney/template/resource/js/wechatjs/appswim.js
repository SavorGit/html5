define('appswim',['appsocket','jquery.shake','wechatcore','touch'],function(appsocket,Shake,wechatcore,touch){
	...
	var appswim = {
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gameswimrefresh'||data.type=='gameappswimrefresh'){
