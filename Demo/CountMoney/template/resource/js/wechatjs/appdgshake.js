define('appdgshake',['appsocket','jquery.shake','wechatcore'],function(appsocket,Shake,wechatcore){
	...
	var appdgshake = {
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gamedgshakerefresh'||data.type=='gameappdgshakerefresh'){
