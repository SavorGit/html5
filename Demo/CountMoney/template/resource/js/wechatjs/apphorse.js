define('apphorse',['appsocket','jquery.shake','wechatcore','touch'],function(appsocket,Shake,wechatcore,touch){
	...
	var apphorse = {
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gamehorserefresh'||data.type=='gameapphorserefresh'){
