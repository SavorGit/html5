define('screenmls',['screensocket','screencore','template','layerBox','fulldm','keyboard'],function(screensocket,screencore,template,layerBox,fulldm,keyboardJS){
	var screenmls = {
		gamestatus:0,
		stopclick:false,
		maxscore: 120,
		...
		init: function() {
			...
			params.onmessage = function(data){
				...
				}else if(data.type=='gamemlsrefresh'||data.type=='gameerrorhaddone'){
