...
IS_TOUCH, SCREEN_SHOW_ALL = !0; (function(a, d) {
	...
	window.onload = function() {
		...
		h.audio && (IS_ANDROID ? a.queue.loadFile({
			id: "sound",
			src: "./template/resource/images/mobile/all.mp3"
	...
	a.showMoreGames = function(b) {
		if (null == e) {
			e = new createjs.Text("\u3010\u66f4\u591a6e\u6e38\u620f\u3011", "28px Arial", "#404040");//【更多6e游戏】
			e.textAlign = "right";
...
function MyProgressBar(a, d, b) {
	...
	b.y = 150;
	b.textAlign = "center";
	//this.addChild(b);   //微信公众号                        //6e手机游戏
	b = new createjs.Text("\u5fae\u4fe1\u516c\u4f17\u53f7: 6e\u624b\u673a\u6e38\u620f", "38px Arial", "black");
	b.x = a / 2;
	b.y = 260;
	b.textAlign = "center";
	//this.addChild(b);
	b = new createjs.Text("\u00a92014 6e\u6e38\u620f", "32px Arial", "black");
	b.x = a / 2;
	b.y = d - 100;
	b.textAlign = "center";
	//this.addChild(b)
