...
$.extend(DG.OnOffSwitch.prototype, {
    ...
    isCheckbox: false,
    render: function () {
		this.textOn == ""&&this.inputEl.attr('data-texton');
		this.textOff == ""&&this.inputEl.attr('data-textoff');
        if (this.width == 0) {
    ...
    renderTrack: function () {
        ...
        this.track = $('<div class="on-off-switch-track" style="border-radius:' + borderWidth + "px;border-width:" + this.trackBorderWidth + "px;" + "width:" + trackWidth + "px;" + "height:" + trackHeight + 'px"></div>');
    ...
    renderThumb: function () {
        ...
        var shadow = $('<div class="on-off-switch-thumb-shadow" style="border-radius:' + borderRadius + "px;width:" + size + "px;height:" + size + "px;border-width:" + borderSize + 'px;"></div>');
